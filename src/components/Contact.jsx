                  ...
                  <a
                    ...
                    onClick={() => {
                      ...
                      if (c.href.startsWith("tel:")) {
                        window.gtag('event', 'Phone_Call_Click', { event_category: 'Contact', event_label: c.sub });
                      } else if (c.href.includes("wa.me")) {
                        window.gtag('event', 'whatsapp_click', { event_category: 'Contact', event_label: 'WhatsApp Chat' });
                      }
                    }}
                  >
