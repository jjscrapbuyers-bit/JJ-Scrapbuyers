...
export default function HowItWorks() {
  ...
  const handleClick = (e) => {
    if (window.gtag) window.gtag('event', 'Phone_Call_Click', { event_category: 'Contact', event_label: 'How It Works CTA' });
    if (!isMobile) {
      e.preventDefault();
  ...
  const handleWhatsAppClick = () => {
    if (window.gtag) window.gtag('event', 'whatsapp_click', { event_category: 'Contact', event_label: 'How It Works CTA' });
  };
...
.cta-btn:hover svg {
  ...
  About JJ Scrapbuyers Chennai scrap service
            ...
            <div className="flex items-center gap-5 flex-wrap">
              ...
              <a href="https://wa.me/919789075963" className="cta-ghost-btn" onClick={handleWhatsAppClick}>
                <span
                  style={{
