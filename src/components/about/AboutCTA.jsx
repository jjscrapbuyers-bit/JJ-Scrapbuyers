...
export default function AboutCTA() {
  ...
  const handleClick = (e) => {
    if (window.gtag) window.gtag('event', 'Phone_Call_Click', { event_category: 'Contact', event_label: 'About CTA' });
    if (!isMobile) {
      e.preventDefault();
  ...
  const handleWhatsAppClick = () => {
    if (window.gtag) window.gtag('event', 'whatsapp_click', { event_category: 'Contact', event_label: 'About CTA' });
  };
        ...
        <div className="cta-wrap">
          ...
          <div ref={revealRef} className="cta-inner" data-reveal>
            ...
            <div className="cta-actions">
              ...
              <a href="https://wa.me/919789075963" className="cta-btn-ghost" onClick={handleWhatsAppClick}>
